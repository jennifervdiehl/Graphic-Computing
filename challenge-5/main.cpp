...
string objPath = "/Users/i587264/Documents/Personal/University/PG_CG/Graphic-Computing/challenge-5/objects/";
...
int main()
{
    ...
    Shader shader(
        "/Users/i587264/Documents/Personal/University/PG_CG/Graphic-Computing/challenge-5/shaders/vertex-shader.vs",
        "/Users/i587264/Documents/Personal/University/PG_CG/Graphic-Computing/challenge-5/shaders/fragment-shader.fs");
...
void setupObjects(GLuint shaderID)
{
    for (int i = 0; i < objectsAmount; i++)
    {
        objects[i] = loadOBJ("/Users/i587264/Documents/Personal/University/PG_CG/Graphic-Computing/challenge-5/objects/suzanneTri.obj");
        loadMTL(&objects[i], i);
    ...
    while (getline(mtlFile, line))
    {
        ...
        if (line.find("map_Kd") == 0)
        {
            ...
            if (i == 0)
                ...
                obj->texture_path = objPath + "Suzanne-devasted.png";
        }
